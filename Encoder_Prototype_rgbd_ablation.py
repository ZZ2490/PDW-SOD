...
class CMF(nn.Module):
    def __init__(self, in_1, in_2):
        ...
        self.pd = Singe_prototype(in_1, 20)
        self.p3 = Singe_prototype(in_1, 20)
...
class CMF1(nn.Module):
    def __init__(self, in_1, in_2):
        super(CMF1, self).__init__()
        self.conv_globalinfo = convblock(in_2, in_1, 1, 1, 0)
        self.conv_fus = convblock(2 * in_1, in_1, 3, 1, 1)  # 不改变图像尺寸，通道数减半
        self.conv_out = convblock(2 * in_1, in_1, 3, 1, 1)
        self.p1 = Singe_prototype(in_1, 20)
...
class Mnet(nn.Module):
    def __init__(self):
        ...
        self.cmf1 = CMF1(64, 128)
        self.cmf2 = CMF1(128, 320)
        self.cmf3 = CMF1(320, 512)
        self.cmf4 = CMF1(512, 512)
