...
parser.add_argument('--val_rgb_root', type=str, default='../RGBT_dataset/test/VT821/RGB/', help='the training RGB images root')
parser.add_argument('--val_t_root', type=str, default='../RGBT_dataset/test/VT821/T/', help='the training Thermal images root')
parser.add_argument('--val_gt_root', type=str, default='../RGBT_dataset/test/VT821/GT/', help='the training GT images root')
